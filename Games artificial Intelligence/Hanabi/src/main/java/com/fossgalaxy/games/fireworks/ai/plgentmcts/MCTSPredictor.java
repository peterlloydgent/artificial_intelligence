 ...
 */
public class MCTSPredictor extends com.fossgalaxy.games.fireworks.ai.plgentmcts.MCTS {
    ...
    public static MCTSPredictor buildPMCTSND(Agent[] agents) {
        return new MCTSPredictor(agents, com.fossgalaxy.games.fireworks.ai.plgentmcts.MCTS.DEFAULT_ITERATIONS, com.fossgalaxy.games.fireworks.ai.plgentmcts.MCTS.NO_LIMIT, MCTS.NO_LIMIT);
    }
