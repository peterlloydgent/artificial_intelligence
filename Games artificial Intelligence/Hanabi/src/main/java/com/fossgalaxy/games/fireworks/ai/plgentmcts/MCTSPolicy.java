 ...
 */
public class MCTSPolicy extends com.fossgalaxy.games.fireworks.ai.plgentmcts.MCTS {
    ...
    public static MCTSPolicy buildPolicyND(Agent rolloutPolicy) {
        return new MCTSPolicy(com.fossgalaxy.games.fireworks.ai.plgentmcts.MCTS.DEFAULT_ITERATIONS, com.fossgalaxy.games.fireworks.ai.plgentmcts.MCTS.NO_LIMIT, MCTS.NO_LIMIT, rolloutPolicy);
    }
