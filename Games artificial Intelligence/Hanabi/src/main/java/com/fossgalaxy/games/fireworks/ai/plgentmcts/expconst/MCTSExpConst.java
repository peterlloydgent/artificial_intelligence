package com.fossgalaxy.games.fireworks.ai.plgentmcts.expconst;
...
//        for (int round = 0; round < roundLength; round++) {
        while(System.currentTimeMillis() < finishTime){
            ...
            com.fossgalaxy.games.fireworks.ai.plgentmcts.IterationObject iterationObject = new com.fossgalaxy.games.fireworks.ai.plgentmcts.IterationObject(agentID);
